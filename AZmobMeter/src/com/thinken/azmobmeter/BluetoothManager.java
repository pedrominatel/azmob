...
//                Log.i(tag, "connected");
        		Intent intent = new Intent(BluetoothManager.this,MeterMenu.class);
    ...
    private void init() {
        ...
        listAdapter= new ArrayAdapter<String>(this, android.R.layout.simple_list_item_single_choice,0);
